...
//  SidestepSDK
//
//  Created by Dmitry Korotchenkov on 01/03/16.
...
FOUNDATION_EXPORT double SidestepSDKVersionNumber;

//! Project version string for SidestepSDK.
FOUNDATION_EXPORT const unsigned char SidestepSDKVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <SidestepSDK/PublicHeader.h>
